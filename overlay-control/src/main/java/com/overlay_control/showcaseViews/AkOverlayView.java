...
import com.overlay_control.R;
import com.overlay_control.showcaseViews.shape.CircleShape;
import com.overlay_control.showcaseViews.shape.NoShape;
import com.overlay_control.showcaseViews.shape.OvalShape;
import com.overlay_control.showcaseViews.shape.RectangleShape;
import com.overlay_control.showcaseViews.shape.Shape;
import com.overlay_control.showcaseViews.target.Target;
import com.overlay_control.showcaseViews.target.ViewTarget;
 ...
 */
public class AkOverlayView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public AkOverlayView(Context context) {
        super(context);
        init(context);
    }

    public AkOverlayView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AkOverlayView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AkOverlayView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void setIsTitleTextShown(boolean isShown) {
        if (mTitleTextView != null) {
            mTitleTextView.setVisibility(isShown ? View.VISIBLE : View.GONE);
        }
    }
    ...
    private void isNumberTextShown(boolean isShown) {
        if (mNumberTextView != null) {
            mNumberTextView.setVisibility(isShown ? View.VISIBLE : View.GONE);
        }
    }
    ...
    private void setNextButtonNTextColor(int textColor, int backColor) {
        if (mNextButton != null && textColor != 0) {
            mNextButton.setTextColor(textColor);
            mNextButton.setBackgroundColor(backColor);
        }
    }
    ...
    private void setIsContentTextShown(boolean isShown) {
        if (mContentTextView != null) {
            mContentTextView.setVisibility(isShown ? View.VISIBLE : View.GONE);
        }
    }
    ...
    private void setSkipTextNBackColor(int textColor, int backColor) {
        if (mSkipButton != null) {
            mSkipButton.setTextColor(textColor);
            mSkipButton.setBackgroundColor(backColor);
            updateSkipButton();
        }
    }
    ...
    public void removeShowcaseListener(AkOverlaySequence showcaseListener) {
    ...
    public static class Builder {
        ...
        final AkOverlayView showcaseView;
        ...
        public Builder(Activity activity) {
            ...
            showcaseView = new AkOverlayView(activity);
        }
        ...
        public Builder setIsContentTextShown(boolean isShown) {
            showcaseView.setIsContentTextShown(isShown);
            return this;
        }
        ...
        public Builder setIsTitleTextShown(boolean isShown) {
            showcaseView.setIsTitleTextShown(isShown);
            return this;
        }
        ...
        public Builder setIsNumberTextShown(boolean isShown) {
            showcaseView.isNumberTextShown(isShown);
            return this;
        }

        /**
         * Set the Overlay Padding from device screen
         */
        ...
        public Builder setNextButtonNTextColor(int textColor, int backColor) {
            showcaseView.setNextButtonNTextColor(textColor, backColor);
            return this;
        }
